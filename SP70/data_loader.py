...
class Vgg_Sound(data.Dataset):
    ...
    def __getitem__(self,index):
        ...
        sudo_label = self.train_files[index][4]
        all_lists = [i for i in self.train_files if sudo_label==i[4]]
        filename_1 = random.choice(all_lists)
        filename_1 = os.path.join(self.path,'video/'+filename_1[0]+'_'+str(filename_1[1]*1000)+'_'+str(filename_1[1]*1000+10000)+'.mp4')

...
training_generator = DataLoader(tr_Dataset, num_workers = cfg['num_workers'],batch_sampler=StratifiedBatchSampler(np.array(tr_Dataset.train_files)[:,2],batch_size = cfg['batch_size']))
